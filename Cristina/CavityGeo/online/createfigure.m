...
set(axes1,'ZMinorTick','on','ZScale','log','FontSize',14);
% Create colorbar
colorbar('peer',axes1,'FontSize',15);
if(caso==0)title('Estime for velocity and pressure');end
if(caso==1)title('Error between FE and RB for vel and pres in T-norm');end
if(caso==2)title('Exact error between FE and RB for temp');end
if(caso==3)title('Estime for temperature');end
if(caso==4)title('\beta_h approximated');end
if(caso==5)title('\beta_h computed');end
