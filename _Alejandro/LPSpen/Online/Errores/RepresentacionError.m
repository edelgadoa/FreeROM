...
errorFIL(6,:) = openfile(['ErrorFIL_',num2str(10),'_Re_',num2str(Re),'_PODtol_',num2str(tol),'.txt']);
%errorFIL(7,:) = openfile(['ErrorFIL_',num2str(20),'_Re_',num2str(Re),'_PODtol_',num2str(tol),'.txt']);
...
legend('POD','PEN','FIL 1','FIL 2','FIL 3','FIL 4','FIL 5','FIL 10','FIL 20');